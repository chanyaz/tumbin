...
public class DashboardPostActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RealmResultsWrapper<RealmResults<Post>> postsWrapper
                = dashboardRealmDao.findByType(Post.PostType.PHOTO);
